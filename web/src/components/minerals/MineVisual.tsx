    ...
    >
      <defs>
        <linearGradient id="mine-sky" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="55%" stopColor="#eaf1eb" />
          <stop offset="100%" stopColor="#d6ded7" />
        </linearGradient>
        <linearGradient id="mine-mtn-far" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#809f91" />
          <stop offset="100%" stopColor="#5e7d70" />
        </linearGradient>
        <linearGradient id="mine-mtn-mid" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#415f54" />
          <stop offset="100%" stopColor="#314e44" />
        </linearGradient>
        ...
        <linearGradient id="mine-pit-inner" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#314e44" />
          <stop offset="100%" stopColor="#213f34" />
        </linearGradient>
        <linearGradient id="mine-ore" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#5e7d70" />
          <stop offset="100%" stopColor="#415f54" />
        </linearGradient>
        <linearGradient id="mine-headframe" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#263F37" />
          <stop offset="100%" stopColor="#173329" />
        </linearGradient>
      ...
      <g>
        ...
        <ellipse cx="460" cy="462" rx="72" ry="14" fill="#5e7d70" opacity="0.55" />
        <ellipse cx="820" cy="472" rx="64" ry="18" fill="url(#mine-ore)" opacity="0.85" />
        <ellipse cx="820" cy="467" rx="50" ry="11" fill="#5e7d70" opacity="0.5" />
        ...
        {/* terrace 3 */}
        <ellipse cx={mineCx} cy={mineCy - 2} rx="148" ry="40" fill="#314e44" />
        <path
        ...
        <ellipse cx={mineCx} cy={mineCy - 22} rx="100" ry="28" fill="#263F37" />
        <ellipse cx={mineCx} cy={mineCy - 18} rx="72" ry="20" fill="#213f34" />
        <ellipse cx={mineCx} cy={mineCy - 14} rx="44" ry="12" fill="#1c3a2f" />

        {/* haul road spiral hint */}
        <path
          d={`M${mineCx - 220} ${mineCy + 30} C${mineCx - 160} ${mineCy - 10}, ${mineCx - 80} ${mineCy + 10}, ${mineCx - 40} ${mineCy - 8}`}
          fill="none"
          stroke="rgba(234, 241, 235,0.12)"
          strokeWidth="3"
          strokeLinecap="round"
        />
        ...
        <g transform={`translate(${mineCx + 118} 248)`}>
          ...
          <polygon points="36,150 54,28 72,150" fill="#1c3a2f" />
          <rect x="10" y="24" width="52" height="7" rx="1" fill="#263F37" />
          <line x1="18" y1="28" x2="54" y2="28" stroke="#5e7d70" strokeWidth="1.5" />
          {/* cable */}
          <line
            x1="36"
            y1="31"
          ...
          />
          {/* skip bucket */}
          <rect x="28" y="95" width="16" height="14" rx="2" fill="#213f34" stroke="#5e7d70" strokeWidth="1" />
        </g>
        ...
        <g>
          ...
          <path
            d={`M${mineCx + 90} ${mineCy + 8} L${mineCx + 200} ${mineCy - 18} L${mineCx + 310} ${mineCy - 28} L920 338`}
            fill="none"
            stroke="rgba(234, 241, 235,0.1)"
            strokeWidth="1"
            strokeDasharray="6 8"
          />
          {/* conveyor supports */}
          <line x1={mineCx + 155} y1={mineCy - 4} x2={mineCx + 155} y2={mineCy + 28} stroke="#213f34" strokeWidth="3" />
          <line x1={mineCx + 255} y1={mineCy - 22} x2={mineCx + 255} y2={mineCy + 12} stroke="#213f34" strokeWidth="3" />
          <line x1={780} y1={332} x2={780} y2={360} stroke="#213f34" strokeWidth="3" />
        </g>

        {/* seal ring — provenance reticle on pit center */}
        <circle cx={mineCx} cy={mineCy} r="72" fill="none" stroke="#B2ED97" strokeWidth="3" opacity="0.85" />
        <circle cx={mineCx} cy={mineCy} r="48" fill="none" stroke="#B2ED97" strokeWidth="2" opacity="0.5" />
        {/* crosshair ticks */}
        <line x1={mineCx - 82} y1={mineCy} x2={mineCx - 74} y2={mineCy} stroke="#B2ED97" strokeWidth="2" opacity="0.7" />
        <line x1={mineCx + 74} y1={mineCy} x2={mineCx + 82} y2={mineCy} stroke="#B2ED97" strokeWidth="2" opacity="0.7" />
        <line x1={mineCx} y1={mineCy - 82} x2={mineCx} y2={mineCy - 74} stroke="#B2ED97" strokeWidth="2" opacity="0.7" />
        <line x1={mineCx} y1={mineCy + 74} x2={mineCx} y2={mineCy + 82} stroke="#B2ED97" strokeWidth="2" opacity="0.7" />
      </g>
      ...
      <circle cx={mineCx} cy={mineCy} r="5" fill="#B2ED97" />
      <circle cx="1320" cy="320" r="6" fill="#6f8f2e" />

      {/* foreground rock silhouettes */}
      <g fill="#132C24" opacity="0.88">
      ...
      <rect x="1260" y="328" width="48" height="32" rx="3" fill="#213f34" stroke="#5e7d70" strokeWidth="1" />
      <rect x="900" y="340" width="380" height="8" rx="4" fill="#263F37" opacity="0.6" />
    </svg>
  );
}
