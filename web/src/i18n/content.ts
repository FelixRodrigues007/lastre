...
export const content = {
  en: {
    ...
    demonstration: {
      ...
      showExplorer: "Show Testnet proofs",
      hideExplorer: "Show live gateway",
      embedTitle: "Casper Testnet evidence — ProofOfOrigin package",
      embedFallback: "If a link is blocked,",
      embedFallbackLink: "open cspr.live directly",
      evidenceAria: "Canonical Casper Testnet proof-of-concept links",
      evidenceKicker: "Casper proof pack",
      evidenceLive: "TESTNET",
      evidenceLead:
        "No blank search page: every row opens a direct CSPR.live package or transaction proof.",
      evidenceNote:
        "Accepted and rejected attestations are intentionally shown; Invalid is permanent evidence, not a hidden failure.",
    },
    minerals: {
  ...
  pt: {
    ...
    demonstration: {
      ...
      showExplorer: "Mostrar provas Testnet",
      hideExplorer: "Mostrar gateway ao vivo",
      embedTitle: "Evidência Casper Testnet — pacote ProofOfOrigin",
      embedFallback: "Se um link for bloqueado,",
      embedFallbackLink: "abra cspr.live diretamente",
      evidenceAria: "Links canônicos das provas de conceito na Casper Testnet",
      evidenceKicker: "Pacote de prova Casper",
      evidenceLive: "TESTNET",
      evidenceLead:
        "Sem página de busca vazia: cada linha abre direto o pacote ou a transação no CSPR.live.",
      evidenceNote:
        "Atestações aceitas e rejeitadas aparecem de propósito; Invalid é evidência permanente, não falha escondida.",
    },
    minerals: {
