...
export const ATMO_PRESETS: Record<AtmoZone, AtmoPreset> = {
  hero: {
    base: "#121407",
    washA: "rgba(254, 241, 111, 0.11)",
    washB: "rgba(111, 143, 46, 0.07)",
    washPosA: "80% -10%",
    washPosB: "0% 0%",
  },
  depth: {
    base: "#181b0c",
    washA: "rgba(197, 199, 176, 0.09)",
  ...
  origin: {
    base: "#1f2211",
    washA: "rgba(111, 143, 46, 0.14)",
    washB: "rgba(254, 241, 111, 0.06)",
    washPosA: "90% 10%",
    washPosB: "0% 100%",
  },
  light: {
    base: "#efeede",
    washA: "rgba(111, 143, 46, 0.08)",
