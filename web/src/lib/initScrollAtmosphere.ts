...
export const ATMO_PRESETS: Record<AtmoZone, AtmoPreset> = {
  ...
  light: {
    ...
    washB: "rgba(178, 237, 151, 0.12)",
    washPosA: "10% 20%",
    washPosB: "90% 90%",
  },
  proof: {
    base: "#16161a",
    washA: "rgba(178, 237, 151, 0.06)",
