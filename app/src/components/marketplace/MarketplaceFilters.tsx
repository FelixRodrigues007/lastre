...
export function MarketplaceFilters({
  ...
  return (
    ...
    >
      <SelectField
        label="Category"
        className="marketplace-filters__field"
        value={category}
        onChange={(event) => {
      ...
      <SelectField
        ...
        value={status}
        onChange={(event) =>
          onStatusChange(event.target.value as MarketplaceStatusFilter)
        }
      ...
      <SelectField
        ...
        value={persona}
        onChange={(event) =>
          onPersonaChange(event.target.value as MarketplacePersona)
        }
